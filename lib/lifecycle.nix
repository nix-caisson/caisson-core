...
# injection as a standalone calculus entry for compositions assembled
# with `compose` directly.
#
# Contracts, shared with the calculus:
#
...
let
  ...
  # duplicates preserved, and applied as anonymous calculus entries
  ...
  # calculus consumer composing entries directly can apply it as (part
